        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="row g-3 mb-3">
                <div className="col-md-4">
                    <label className="form-label-nuevaActu">Nº de personas</label>
                    <input
                ...
                <div className="col-md-4">
                    <label className="form-label-nuevaActu">Caché (€)</label>
                    <input
                        className="form-control"
                        type="number"
                        name="cache"
                ...
                <div className="col-12">
                    <label className="form-label-nuevaActu">Peticiones de la actuación (rider)</label>
                    <textarea
                        className="form-control"
                        name="peticiones"
                        rows="3"
