...
export const Perfil = () => {
  ...
  function getPerfil() {
    fetch("https://verbose-spoon-4j66qqx7qgqw2qxpq-3001.app.github.dev/admin/user", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${store.token}` // Ver si el token está en el store global
      }
    })
      .then(response => response.json())
      .then(result => {
      ...
      .catch(error => console.error('Error en el GET de perfil:', error));
  }
