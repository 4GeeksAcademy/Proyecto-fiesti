...
export const Perfil = () => {
  ...
  return (
    <div className="bodyPerfil">
      ...
      {/* Pago solo organizador sin tarjeta */}
      {needsPayment && (
        <div className="card card-body mt-4">
          <h4>
            <b>Completa tu pago de organizador/a</b>
          </h4>
          ...
          <form onSubmit={doPay} className="row g-3">
            <div className="col-12">
              ...
              <input
                ...
                onChange={(e) =>
                  setCard({ ...card, card_holder: e.target.value })
                }
                required
              />
            </div>
            ...
            <div className="col-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setCard({ ...card, card_expiration: e.target.value })
                }
                required
              />
            </div>
